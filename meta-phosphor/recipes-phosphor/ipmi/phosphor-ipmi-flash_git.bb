...
PACKAGECONFIG_append = " reboot-update static-bmc nuvoton-lpc"
IPMI_FLASH_BMC_ADDRESS = "0xc0008000"
RDEPENDS_${PN} += "phosphor-ipmi-blobs"
SRC_URI += "file://image-verify.service"
SYSTEMD_SERVICE_${PN} += "image-verify.service"
do_install_append() {
	install -D -m0644 -t ${D}/${systemd_system_unitdir} ${WORKDIR}/image-verify.service
}
